...
public class ContactHandler extends SQLiteOpenHelper {
     ...
     */
    public ContactHandler(@androidx.annotation.Nullable Context context, @androidx.annotation.Nullable String name, @androidx.annotation.Nullable SQLiteDatabase.CursorFactory factory, int version) {
